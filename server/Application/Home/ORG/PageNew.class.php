...
class PageNew {
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="prev" href="' . $this->url(1) . '">' . $this->config['gofirst'] . '</a></li><li><a class="prev" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';

        //下一页
        $down_row = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li><li><a class="prev" href="' . $this->url($this->totalPages) . '">' . $this->config['golast'] . '</a></li>' : '';
        ...
        return trim($page_str) ? "<div align=center><ul class=\"pagination\">{$page_str}</ul></div>" : '';
    }
